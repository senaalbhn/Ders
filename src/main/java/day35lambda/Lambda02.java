...
public class Lambda02 {
    public static void main(String[] args) {
        ...
        removeIfStartWithZOrEndWithf(myList);
    ...
    public static void removeIfStartWithZOrEndWithf(List<String>myList){
        myList.removeIf(t -> t.charAt(0)=='Z' || t.charAt(t.length()-1)=='f');
        System.out.println(myList);
    }
    //2.yol
    public static void removeIfStartWithZOrEndWithf2(List<String>myList){
